    ...
    <div>
        ...
        <el-dialog title="新增" v-model="addVisible" width="40%" :append-to-body="true" @opened="handleEdtor">
            <el-form :rules="rules" ref="formData" :model="formData">
                ...
                <el-form-item label="显示名称" class="center" v-if="formData.itemType!==''">
                    <el-input style="width: 70%;" :minlength="2" v-model="formData.translate"
                ...
                <el-form-item class="center"
                    ...
                    <img id="imgDesc" v-if="formData.itemType==='1'&&formData.itemName!==''&&formData.itemName!==null"
        ...
        methods: {
            ...
            handleSelect(item) {
                ...
                if (this.formData.itemType == "1") {
                    ...
                    this.formData.itemIcon = (this.itemNameCache[item.value].icon.Value === null ? this.itemNameCache[item.value].itemname : this.itemNameCache[item.value].icon.Value) + ".png";
