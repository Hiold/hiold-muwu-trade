...
$(document).ready(function(){
	playerBasic = [	//玩家基本数据
		[["名称:彩色の小木屋","steamID:76561199000000001","头像:images/player/muwu.jpg"],
		...
		[["名称:玩家09","steamID:76561199000000012","头像:images/player/head1.jfif"],
		["等级:1","身份:普通玩家","在线时长(h):1"],["拥有积分:900","拥有钻石:0","购物优惠(%):0"],
		["本周签到次数:0","总签到次数:0","总充值金额:0","总消费钻石:0"]],
		
		[["名称:玩家10","steamID:76561199000000013","头像:images/player/head1.jfif"],
		["等级:1","身份:普通玩家","在线时长(h):1"],["拥有积分:800","拥有钻石:0","购物优惠(%):0"],
		["本周签到次数:0","总签到次数:0","总充值金额:0","总消费钻石:0"]],
		
		[["名称:玩家11","steamID:76561199000000014","头像:images/player/head1.jfif"],
		["等级:1","身份:普通玩家","在线时长(h):1"],["拥有积分:700","拥有钻石:0","购物优惠(%):0"],
		["本周签到次数:0","总签到次数:0","总充值金额:0","总消费钻石:0"]],
		
		[["名称:玩家12","steamID:76561199000000015","头像:images/player/head1.jfif"],
		["等级:1","身份:普通玩家","在线时长(h):1"],["拥有积分:600","拥有钻石:10","购物优惠(%):0"],
		["本周签到次数:0","总签到次数:0","总充值金额:0","总消费钻石:0"]],
		
		[["名称:玩家13","steamID:76561199000000016","头像:images/player/head1.jfif"],
		["等级:1","身份:普通玩家","在线时长(h):1"],["拥有积分:500","拥有钻石:5","购物优惠(%):0"],
		["本周签到次数:0","总签到次数:0","总充值金额:0","总消费钻石:0"]],
		
		[["名称:玩家14","steamID:76561199000000017","头像:images/player/head1.jfif"],
		["等级:1","身份:普通玩家","在线时长(h):1"],["拥有积分:140","拥有钻石:0","购物优惠(%):0"],
		["本周签到次数:0","总签到次数:0","总充值金额:0","总消费钻石:0"]],
		
		[["名称:玩家15","steamID:76561199000000018","头像:images/player/head1.jfif"],
		["等级:1","身份:普通玩家","在线时长(h):1"],["拥有积分:150","拥有钻石:0","购物优惠(%):0"],
		["本周签到次数:0","总签到次数:0","总充值金额:0","总消费钻石:0"]],
		
		[["名称:玩家16","steamID:76561199000000019","头像:images/player/head1.jfif"],
		["等级:1","身份:普通玩家","在线时长(h):1"],["拥有积分:160","拥有钻石:0","购物优惠(%):0"],
		["本周签到次数:0","总签到次数:0","总充值金额:0","总消费钻石:0"]],
		
		[["名称:玩家17","steamID:76561199000000020","头像:images/player/head1.jfif"],
		["等级:1","身份:普通玩家","在线时长(h):1"],["拥有积分:170","拥有钻石:0","购物优惠(%):0"],
		["本周签到次数:0","总签到次数:0","总充值金额:0","总消费钻石:0"]],
		
		[["名称:玩家18","steamID:76561199000000021","头像:images/player/head1.jfif"],
		["等级:1","身份:普通玩家","在线时长(h):1"],["拥有积分:180","拥有钻石:0","购物优惠(%):0"],
		["本周签到次数:0","总签到次数:0","总充值金额:0","总消费钻石:0"]],
		
		[["名称:玩家19","steamID:76561199000000022","头像:images/player/head1.jfif"],
		["等级:1","身份:普通玩家","在线时长(h):1"],["拥有积分:190","拥有钻石:0","购物优惠(%):0"],
		["本周签到次数:0","总签到次数:0","总充值金额:0","总消费钻石:0"]],
		
		[["名称:玩家20","steamID:76561199000000023","头像:images/player/head1.jfif"],
		["等级:1","身份:普通玩家","在线时长(h):1"],["拥有积分:200","拥有钻石:0","购物优惠(%):0"],
		["本周签到次数:0","总签到次数:0","总充值金额:0","总消费钻石:0"]],
		
		[["名称:玩家21","steamID:76561199000000024","头像:images/player/head1.jfif"],
		["等级:1","身份:普通玩家","在线时长(h):1"],["拥有积分:210","拥有钻石:10","购物优惠(%):0"],
		["本周签到次数:0","总签到次数:0","总充值金额:0","总消费钻石:0"]],
		
		[["名称:玩家22","steamID:76561199000000025","头像:images/player/head1.jfif"],
		["等级:1","身份:普通玩家","在线时长(h):1"],["拥有积分:220","拥有钻石:20","购物优惠(%):0"],
		["本周签到次数:0","总签到次数:0","总充值金额:0","总消费钻石:0"]],
		
		[["名称:玩家23","steamID:76561199000000026","头像:images/player/head1.jfif"],
		["等级:1","身份:普通玩家","在线时长(h):1"],["拥有积分:230","拥有钻石:23","购物优惠(%):0"],
		["本周签到次数:0","总签到次数:0","总充值金额:0","总消费钻石:0"]],
		
		[["名称:玩家24","steamID:76561199000000027","头像:images/player/head1.jfif"],
		["等级:1","身份:普通玩家","在线时长(h):1"],["拥有积分:240","拥有钻石:23","购物优惠(%):0"],
		["本周签到次数:0","总签到次数:0","总充值金额:0","总消费钻石:0"]],
	];
