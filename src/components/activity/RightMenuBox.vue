    ...
    <header data-more="false">    <!-- 右上角资料卡 -->
      ...
      <ul class="aside-profile">
        <div class="page1">    <!-- 基础信息 -->
          ...
          <p class="my-sf">
            个人身份：<span>{{ playerinfo.type == "1" ? "管理员" : playerinfo.vipdiscount * 1 > 0 ? "VIP用户" : "普通用户" }}</span>
          </p>
