<template>
    <div id="box">
        <left-container-box></left-container-box>
        <right-container-box></right-container-box>
    </div>
</template>

<script>
    import LeftContainerBox from "./box/LeftContainerBox";
    import RightMenuBox from "./box/RightMenuBox";
    //引入juqery
    import $ from 'jquery'
        ...
        methods: {
            adaptive() {
                ...
                if (window.orientation === 180 || window.orientation === 0) {
                    ...
                    console.log('竖屏状态！---Width=' + Width + "---Height=" + Height + "----Box-Height=" + $("#box").height() + "----Box-Width=" + $("#box").width());
                    $("#box").css({
                ...
                var h7 = $(".items-box>.items>header:visible").height();
                var h8 = $(".items-box>.items>header>i:visible").height();
                var h9 = $(".items-box>.items>footer:visible").height();
                ...
                var h12_1 = $(".terr-box").height();
                var h12_2 = $(".terr-box>header").height();
                ...
                $(".terr-box>section").css({"height": h12_3 + "px"});
