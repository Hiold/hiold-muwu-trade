<template>
    <div id="box">
        ...
        <left-container-box :itemMenu="itemMenu" :class1="class1" :class2="class2" @setclass1="setclass1"
                            @setclass2="setclass2"></left-container-box>
...
<script>
    ...
    import LeftContainerBox from "/src/components/trans/LeftContainerBox.vue";
    import RightMenuBox from "/src/components/trans/RightMenuBox.vue";
    import $ from "jquery";
    ...
    export default {
        ...
        methods: {
            ...
            adaptive() {
                ...
                console.log(h17,h17_1,h17_2,h17_4);
